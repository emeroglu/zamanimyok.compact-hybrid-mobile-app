...
{
    public class ReservationsWelcomer : CorePostLoginWebAgent<ReservationsPayload, ReservationsDelivery>
    {
        ...
        protected override void On_Instance_Validated()
        {
            ...
            List<flowReservation> listReservations = Entities.flowReservations.Where(r => r.Present && r.flowRequest.UserFK == User.PK && limit < r.CreateDate).OrderByDescending(r => r.CreateDate).ToList();
            ...
            Delivery.meta.message = "Here are the active reservations for your user";

            Delivery.payload.reservations = json;
        }
    }

    public class ReservationsPayload : CorePayload
    {

    }

    public class ReservationsDelivery : CorePayload
    {
