...
{
    public class VerifyEmailWelcomer : CoreWebAgent<VerifyEmailPayload, VerifyEmailDelivery>
    {
        ...
        protected override void On_Ready()
        {
            ...
            {
                Delivery.meta.status = "allocated";
                Delivery.meta.message = "Email is in use";
    ...
    public class VerifyEmailPayload : CorePayload
    {
        public string email { get; set; }
    }

    public class VerifyEmailDelivery : CorePayload
    {
