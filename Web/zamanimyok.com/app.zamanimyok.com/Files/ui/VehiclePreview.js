$js.compile("VehiclePreview", [View], function($self) {
    ...
    $self.overrides = {
        ...
        on_tag: function() { return "z-vehicle-preview"; },
    ...
    $css.select("z-vehicle-preview z-view[z-name='v_item']")
        .begin()
            .relativeLeft()
    ...
    $css.select("z-vehicle-preview z-view[z-name='v_image']")
        .begin()
            .absolute()
            .sideFull()
            .opacity(0.1)
    ...
    $css.select("z-vehicle-preview z-view[z-name='v_image'] img")
        .begin()            
            .sideCentered(90)            
        .save();

    $css.select("z-vehicle-preview z-view[z-name='v_info']")
        .begin()
            .absolute()
            .widthCentered(150)
            .height(75)
    ...
    $css.merge("z-vehicle-preview z-view[z-name='v_model']", "z-vehicle-preview z-view[z-name='v_brand']", "z-vehicle-preview z-view[z-name='v_plate']")
        .begin()
            .relativeLeft()
            .widthFull()
            .height(25)
