$js.compile("VehicleSelectionItem", [View], function($self) {
    ...
    $self.overrides = {
        ...
        on_tag: function() { return "z-vehicle-selection-item"; },
        ...
        on_construct: function($views) {
            ...
            $views.item = new View().init({ name: "v_item" })
                .onClick(function () {
                    ...
                    $data.new_request.vehicle = $self.vehicle;

                    $api.addresses(function() { $nav.to("take_over_address_selection"); });                 
    ...
    $css.select("z-vehicle-selection-item z-view[z-name='v_item']")
        .begin()
            .relativeLeft()
    ...
    $css.select("z-vehicle-selection-item z-view[z-name='v_image']")
        .begin()
            .absolute()
            .sideFull()
            .opacity(0.1)
    ...
    $css.select("z-vehicle-selection-item z-view[z-name='v_image'] img")
        .begin()            
            .sideCentered(90)            
        .save();

    $css.select("z-vehicle-selection-item z-view[z-name='v_info']")
        .begin()
            .absolute()
            .widthCentered(150)
            .height(75)
    ...
    $css.merge("z-vehicle-selection-item z-view[z-name='v_model']", "z-vehicle-selection-item z-view[z-name='v_brand']", "z-vehicle-selection-item z-view[z-name='v_plate']")
        .begin()
            .relativeLeft()
            .widthFull()
            .height(25)
