using crm.zamanimyok.com.Repository;
using System;
...
namespace crm.zamanimyok.com.Controllers
{
    public class SysController : Controller
    {
        ...
        public string Keep_Alive(int seconds)
        {
            ...
            html += "<html>";
            html += "   <head>";
            html += "       <title>CMS - Keep Alive</title>";
            html += "   </head>";
            html += "   <body>";
        ...
        public string Refresh()
        {
            ...
            return "Refreshed At: " + Cache.Last_Refresh.ToString(Date_Format);
        }
    }
}